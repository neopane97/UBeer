...
//  WorldTrotter
//
//  Created by Lorin Brown on 9/26/16.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        else
        {
            ...
            let homeController = nc.topViewController as! HomeViewController
//            var homePage = mainStoryboard.instantiateViewControllerWithIdentifier("homePageView") as! HomeViewController
